...
from .af import AF2d
from ...networks.auto_regressives.made import MADE2d
...
class AF2dMADE(AF2d):
    ...
    def __init__(
        ...
        hidden_kernels = [
            kernel_size
        ] * num_hiddens if hidden_kernels is None else hidden_kernels
        self.blocks = []
        for i in range(num_blocks):
            block = AF2dMADEDualBlock(
                in_channels,
                kernel_size,
                num_hiddens,
                hidden_channels,
